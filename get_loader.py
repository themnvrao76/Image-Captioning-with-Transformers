...
def get_loader(
    ...
    dataset = FlickerData(root_folder,caption_file,transform=transform)
...
if __name__ == "__main__":
    ...
    dataloader,dataset=get_loader(r"M:\Python\Text Processing\Dataset\Images",r"M:\Python\Text Processing\Dataset\captions.txt",transform=transform)
